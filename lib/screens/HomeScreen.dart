...
var cityName = ["Mumbai", "Delhi", "Chennai", "Dhar", "Indore", "London","Udaipur"];
                  ...
                  child: Container(
                    ...
                    child:  Column(
                      children: [
                        ...
                        SizedBox(height: 30,)
                        ,
                        Text(hHumadity,style: TextStyle(
                            fontSize: 40,
                            fontWeight: FontWeight.bold
                        ),),
                        Text("Percent")
